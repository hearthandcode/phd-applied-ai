...
Par vs. actual hours by module and phase. "Par" is the estimated hours at a moderate,
sustainable pace — aspirational, not prescriptive. Being over par means you went deep.
Being under par means you moved fast. Neither is bad.

**Par scores** are set during Workflow Phase A. Actual hours are filled in from `audit.md`
entries as studying progresses.
